...
export function KursVerwaltungDialog({ open, onClose, onSubmit, defaultValues, kursleiter_verwaltungList, enablePhotoScan = true, enablePhotoLocation = true }: KursVerwaltungDialogProps) {
